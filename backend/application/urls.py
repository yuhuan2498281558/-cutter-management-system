...
from application.bimface_views import (
    BimfaceViewTokenView,
    BimfaceComponentPropertiesView,
    BimfaceCutterModelMappingView,
    BimfaceCutterStatusView,
)
...
urlpatterns = (
        [
            ...
            # bimface
            path('api/bimface/view-token/', BimfaceViewTokenView.as_view(), name='bimface_view_token'),
            path('api/bimface/cutter-model-mapping/', BimfaceCutterModelMappingView.as_view(), name='bimface_cutter_model_mapping'),
            path('api/bimface/cutter-status/', BimfaceCutterStatusView.as_view(), name='bimface_cutter_status'),
            path('api/bimface/component/<str:component_id>/properties/', BimfaceComponentPropertiesView.as_view(), name='bimface_component_props'),
        ]
