"""Safe configuration template for local development.

Copy the values you need into environment variables or a local env file.
Never commit real passwords, tokens, or project identifiers.
"""
