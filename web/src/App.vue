<template>
	<el-config-provider :size="getGlobalComponentSize" :locale="getGlobalI18n">
		...
		<Setings v-if="!isMobileRoute" ref="setingsRef" v-show="themeConfig.lockScreenTime > 1" />
		<CloseFull v-if="!themeConfig.isLockScreen && !isMobileRoute" />
...
watch(
	...
	() => {
		other.useTitle();
    if (!isMobileRoute.value && route.path !== '/login' && !websocket.websocket) {
      //websockt 模块
      try {
